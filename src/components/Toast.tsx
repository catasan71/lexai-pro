...
export function Toast({ msg, type, onClose }: ToastProps) {
  ...
  return (
    <div style={{ position:"fixed",bottom:16,left:16,right:16,zIndex:9999,background:"#0f172a",border:"1px solid "+col[type]+"40",borderLeft:"3px solid "+col[type],borderRadius:12,padding:"13px 16px",display:"flex",alignItems:"flex-start",gap:10,boxShadow:"0 8px 32px "+col[type]+"20",animation:"slideUp .3s ease",maxWidth:480,marginInline:"auto",fontFamily:"'Inter',sans-serif" }}>
